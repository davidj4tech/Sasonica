...
//   notify  background notifications' toggle in Settings, in a faked Android
//           shell: on by default and synced once paired, off/on kept, the
//           refused-permission hint, a notification tap opens its thread,
//           unpair stops it; absent in a browser
...
//   share   shared to the app: New chat / Into a thread leave the words in
//           that draft, Organiser inbox captures a TODO, Play it a link
//   interrupted  a reply stopped part way (`spoken.resume`): "Resume" with its
//           time sends replay-id from the first unheard sentence, a restart
//           key from the top; the unheard words are dimmed; others keep ▶
