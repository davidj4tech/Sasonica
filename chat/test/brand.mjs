...
for (const [name, vp, size, px] of [['portrait', { width: 390, height: 780 }, 'default', 15], ['landscape', { width: 844, height: 390 }, 'default', 15], ['portrait-larger', { width: 390, height: 780 }, 'largest', 22]]) {
  ...
  ok(wm.mark >= 20 && wm.mark <= 48, `${name}: the mark is ~28 px (${wm.mark})`)
