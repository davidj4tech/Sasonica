...
ok(JSON.stringify(order) === JSON.stringify(['dash-needs', 'dash-working', 'dash-listening', 'dash-recaps', 'dash-start', 'dash-machines']), `home: sections top to bottom (${order.join(', ')})`)
