...
await page.waitForSelector('.new-summary >> text=agent-media', { timeout: 5000 }).catch(() => {})
const on = await page.locator('.new-summary').innerText()
ok(on.includes('agent-media · Claude'), `quick: New chat opens preset (${on})`)
